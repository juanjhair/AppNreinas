...
/**
 * A specialization of the PruebaDeMeta interface so that it is possible to check
 ...
 */
public interface RevisorDeSolucion extends PruebaDeMeta {
	/**
	 * This method is only called if PruebaDeMeta.isGoalState() returns true.
	 * 
	 * @param actions
	 ...
	 */
	boolean isAcceptableSolution(List<Accion> actions, Object goal);
}