...
public class Problema {
	 ...
	 */
	public Problema(Object initialState, FuncionAcciones actionsFunction,
			FuncionResultado resultFunction, PruebaDeMeta goalTest) {
	...
	public Problema(Object initialState, FuncionAcciones actionsFunction,
			FuncionResultado resultFunction, PruebaDeMeta goalTest,
			FuncionCostoDePaso stepCostFunction) {
	 ...
	 */
	public FuncionResultado getResultFunction() {
